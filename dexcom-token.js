exports.handler = async function(event, context) {
  ...
  try {
    ...
    if (!clientId || !clientSecret) {
      return { statusCode: 500, headers, body: JSON.stringify({ error: 'Environment variables not configured — add DEXCOM_CLIENT_ID and DEXCOM_CLIENT_SECRET in Netlify site settings.' }) };
    }
